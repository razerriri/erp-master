					   ...
					   Create Timesheet
									...
									<div>
										<table class="table table-striped table-bordered table-advance table-hover" id="table1" role="grid">
											<thead>
												<tr role="row">
													<th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width:15%">Date</th>
													<th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
													 Full Name
												: activate to sort column ascending" style="width: 5%;">Time In</th>
													<th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
													 Points
												: activate to sort column ascending" style="width: 10%;">Time Out</th>
											</thead>
											<tbody>
												<c:forEach var="att" items="${listAttend}">
		                                        <tr>
		                                        	<td>${att.td_Entry_Date}</td>
		                                        	<td>${att.td_time_in}</td>
		                                        	<td>${att.td_time_out}</td>
		                                        </tr>
		                                        </c:forEach>
											</tbody>
										</table>
			...
			<div class="modal fade in" id="createtimesheet" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-xs" style="width:300px">
                        <div class="modal-content">
                          ...
                          <center>
							<a data-toggle="modal" data-href="#createtimesheet2" href="#createtimesheet2" class="btn btn-default">Weekly Timesheet</a>
							<br><br>
							<a data-toggle="modal" data-href="#createtimesheet1" href="#createtimesheet1" class="btn btn-default">Monthly Timesheet</a>
							<br><br>
							<a data-toggle="modal" data-href="#createtimesheet3" href="#createtimesheet3" class="btn btn-default">Semi-Monthly Timesheet</a>
                      	  </center>
              ...
              <div class="modal fade in" id="createtimesheet1" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-xs" style="width:300px">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title modal-success">MONTHLY TIMESHEET</h4>
                            </div>
                            <div class="modal-body">
                       
                          
							<form:form class="form-horizontal" method="post" action="save0" modelAttribute="awta">
                       <label class="control-label">Select month of timesheet</label>
                      <form:input type="text" path="ttype" value="Monthly" style="display:none;" class="form-control"></form:input>
                          <form:select path="forthemonthof" id="forthemonthof" name="forthemonthof" class="form-control">
                ...
                <div class="modal fade in" id="createtimesheet2" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-xs" style="width:300px">
                        <div class="modal-content">
                          ...
                          <label class="control-label">Select start date of timesheet</label>
							<form:form class="form-horizontal" method="post" action="save1" modelAttribute="awta">
                       <!--  -->
                       <!--  -->	
                      
					   <form:input type="text" path="ttype" value="Weekly" style="display: none;" class="form-control"></form:input>
					   <form:input type="text" path="tdaysno" value="7" style="display: none;" class="form-control"></form:input>
                ...
                <div class="modal fade in" id="createtimesheet3" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-xs" style="width:300px">
					   ...
					   <form:input type="text" path="ttype" value="Semi-Monthly" style="display:none;" class="form-control"></form:input>
					    <form:input type="text" path="tdaysno" value="15" style="display:none;" class="form-control"></form:input>
                       <form:input size="16" type="date" path="weekstart"  class="form-control"></form:input>
