                                        ...
                                        <tbody>
											   <c:forEach var="e" items="${list}">
                                      			    <tr>
                            			                <td>${e.emp_id }</td>
                            			                <td>${e.emp_number }</td>	
			                                            <td>${e.emp_first_name }</td>	
			                                            <td>${e.emp_middle_name }</td>	
			                                            <td>${e.emp_last_name }</td>	
			                                            <td>${e.emp_hire_date }</td>	
			                                            <td>${e.emp_status }</td>	
			                                           
			                                           <td>
                                           <button class="btn btn-success" href="#responsive" data-toggle="modal" data-id="${e.emp_id }" data-number="${e.emp_number }" data-fname="${e.emp_first_name }" data-mname="${e.emp_middle_name }"data-lname="${e.emp_last_name }"data-age="${e.emp_hire_date }"data-contactnumber="${e.emp_status }"> Edit</button>	
   ...
   <!-- global js -->
    ...
    <script src="<c:url value="/resources/vendors/modal/js/modalEffects.js"/>"></script>
     ...
     $('#responsive').on('show.bs.modal', function (e) {
   	  ...
   	  var empnumber=$(opener).attr('data-number');
   	  ...
   	  //set what we got to our form
     	 ...
     	 $('#updateForm').find('[id="number"]').val(empnumber);
