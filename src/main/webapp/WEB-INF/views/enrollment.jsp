        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>Enrollment</h1>
                        ...
                        <!-- Tables -->
                        <a type="button" class="btn btn-primary" href="http://127.0.0.1:62582/viewer/frameset?__report=C%3A%5Cbirt%5Cworkspace%5CLMSREPORT.rptdesign&__format=html&__svg=true&__locale=en_PH&__timezone=Singapore&__masterpage=true&__rtl=false&__cubememsize=10&__resourceFolder=C%3A%5Cbirt%5Cworkspace&985233374" style="margin-left:940px; margin-bottom:10px;">Generate Report</a>
                     <div class="col-md-6">
